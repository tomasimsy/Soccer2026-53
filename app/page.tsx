        ...
        {standings.map((team, idx) => (
          ...
          >
            ...
            <td className="p-4 text-center">
              <span
                className={`inline-block px-3 py-1 rounded-lg font-bold shadow-md ${
                  idx === 0
...
<section className="relative max-w-6xl mx-auto px-4 py-16 overflow-hidden">
  ...
  {/* Stadium glow background */}
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,160,72,0.10),transparent_60%)]" />
  ...
  <div className="relative text-center mb-10">
    ...
    <p className="text-gray-400 mt-2">
      The guardians of fairness. The voice of the stadium.
    </p>
  </div>
  ...
  <div className="relative grid md:grid-cols-2 gap-8">
    ...
    {/* REFEREES */}
    <div className="bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl p-6 shadow-[0_0_40px_rgba(212,160,72,0.08)] relative overflow-hidden">

      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#d4a048] to-transparent" />

      <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
        <span>⚖️ Referees</span>
        <span className="text-[#d4a048] animate-pulse">🏆</span>
      </h3>
      ...
      <div className="space-y-4">
        ...
        {/* Main Ref */}
        <div className="flex items-center justify-between p-4 rounded-xl bg-[#d4a048]/10 border border-[#d4a048]/30">
          <div>
            <p className="text-lg font-bold text-white flex items-center gap-2">
              👑 David
            </p>
            <p className="text-xs text-gray-400">Main Referee • The Final Authority</p>
          </div>
          <span className="px-3 py-1 text-xs font-bold bg-[#d4a048] text-black rounded-full">
            MAIN
          </span>
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
          <div>
            ...
            <p className="text-xs text-gray-400">Sideline Referee</p>
          </div>
    ...
    <div className="bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl p-6 shadow-[0_0_40px_rgba(212,160,72,0.08)] relative overflow-hidden">
      ...
      <p className="text-gray-400 text-sm mb-6">
        Bringing energy, hype, and stadium-level chaos to every match day.
      </p>

      <div className="space-y-4">

        <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-[#d4a048]/10 to-transparent border border-[#d4a048]/20">
          <div>
            <p className="text-lg font-bold text-white flex items-center gap-2">
              🎙 Tom
            </p>
            <p className="text-xs text-gray-400">Main Host • Voice of the Cup</p>
          </div>
          <span className="px-3 py-1 text-xs font-bold bg-[#d4a048] text-black rounded-full">
            LIVE
          </span>
        ...
        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
          <div>
            ...
            <p className="text-xs text-gray-400">Co-Host • Crowd Energizer</p>
          </div>
          <span className="px-3 py-1 text-xs font-semibold bg-white/10 text-gray-300 rounded-full">
            CO-HOST
          </span>
      ...
      {/* Bottom glow */}
      <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#d4a048] to-transparent" />
    </div>
