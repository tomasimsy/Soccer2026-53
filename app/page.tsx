  ...
  const [schedule, setSchedule] = useState<WeekSchedule[]>([]);
    ...
    const [editingGame, setEditingGame] = useState<string | null>(null);
      const [editValues, setEditValues] = useState<{ [key: string]: { home: number; away: number } }>({});
        const ADMIN_CODE = "1234"; // change this to whatever you want
...
const [pendingAction, setPendingAction] = useState<null | (() => void)>(null);
        ...
        } else if (match.home_score < match.away_score) { away.wins++; home.losses++; away.points +=3;
          home.form.unshift('L'); away.form.unshift('W'); } else { home.draws++; away.draws++; home.points +=1;
          away.points +=1; home.form.unshift('D'); away.form.unshift('D'); } if (home.form.length> 5) home.form.pop();
      ...
      backgroundImage:
        "url('https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=2070&auto=format&fit=crop')",
                ...
                <div className="text-center">
                  ...
                  <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
                    <div className="text-center bg-white/5 rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                      <div className="text-3xl md:text-4xl font-black text-[#d4a048]">
                        4
                      </div>
            ...
            <section className="relative max-w-6xl mx-auto px-4 py-16 overflow-hidden">
              ...
              <div
                className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,160,72,0.12),transparent_60%)]" />

              {/* Subtle field lines */}
              <div className="absolute inset-0 opacity-[0.05]">
                <div className="absolute inset-y-0 left-1/2 w-[2px] bg-white" />
                <div
                  className="absolute top-1/2 left-1/2 w-[500px] h-[500px] border border-white rounded-full -translate-x-1/2 -translate-y-1/2" />
              </div>
              ...
              <div className="relative flex items-center justify-between mb-8">
                ...
                <div
                  className="flex items-center gap-2 text-sm text-gray-300 bg-white/5 px-3 py-2 rounded-full border border-[#d4a048]/30 backdrop-blur-sm">
              ...
              {/* Table wrapper */}
              <div
                className="relative overflow-x-auto rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_0_40px_rgba(212,160,72,0.08)]">
                  ...
                  <tbody>
                    ...
                    <tr key={team.team} className={`border-t border-white/5 transition duration-200 hover:bg-white/10 ${
                      ...
                      <td className="p-4 text-center">
                        <span className={`inline-block px-3 py-1 rounded-lg font-bold shadow-md ${ idx===0
                          ? "bg-[#d4a048] text-black shadow-[#d4a048]/40" : "bg-white/10 text-green-300" }`}>
                          {team.points}
                        </span>
                      </td>
                    </tr>
                    ...
                    <div key={game.id} className="border-t border-white/10 pt-3 first:border-t-0 first:pt-0">
                      ...
                      <div>
                        ...
                        <button onClick={()=> {
                          ...
                          className="w-full py-2 bg-[#d4a048]/20 rounded-lg text-sm font-semibold text-[#d4a048]
                          hover:bg-[#d4a048]/30 transition"
                          >
                          ✏️ Edit Score
                        </button>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex gap-2">
                          ...
                          className="w-full p-2 rounded bg-black/30 border border-white/10 text-center
                          focus:border-[#d4a048] outline-none"
                          placeholder="Home"
                          />
                        ...
                        <div className="flex gap-2">
                          <button onClick={()=> updateScore(
                            ...
                            disabled={saving}
                            className="flex-1 py-2 bg-green-600 rounded-lg text-sm font-semibold hover:bg-green-500
                            transition"
                            >
                      ...
                      <div className="space-y-2">
                        ...
                        <button onClick={()=> {
                          ...
                          disabled={saving}
                          className="w-full py-2 bg-[#d4a048] rounded-lg text-sm font-semibold text-black
                          hover:bg-[#e8b84a] transition"
                          >
                          Record Result
                        </button>
                      </div>
